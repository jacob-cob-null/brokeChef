export function searchInput() {
    ...
    div.className = "flex justify-center items-start p-3 gap-2 rounded-3xl h-fit bg-white drop-shadow-md outline-1 outline-slate-100 "
    div.innerHTML = `<form class="flex justify-center w-full items-start h-full">
          ...
          >
            <span class="material-icons !text-4xl text-emerald-900">search</span>`
